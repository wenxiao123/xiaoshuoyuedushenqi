...
public class CollBookBeanDao extends AbstractDao<CollBookBean, String> {
    ...
    public CollBookBeanDao(DaoConfig config, com.example.administrator.xiaoshuoyuedushenqi.weyue.db.gen.DaoSession daoSession) {
        super(config);
    }
    
    public CollBookBeanDao(DaoConfig config, com.example.administrator.xiaoshuoyuedushenqi.weyue.db.entity.DaoSession daoSession) {
