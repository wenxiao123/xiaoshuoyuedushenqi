package com.example.administrator.xiaoshuoyuedushenqi.weyue.db.gen;
...
import com.example.administrator.xiaoshuoyuedushenqi.weyue.db.entity.DaoSession;
...
public class DownloadTaskBeanDao extends AbstractDao<DownloadTaskBean, String> {
    ...
    public DownloadTaskBeanDao(DaoConfig config, com.example.administrator.xiaoshuoyuedushenqi.weyue.db.gen.DaoSession daoSession) {
        super(config);
    }
    
    public DownloadTaskBeanDao(DaoConfig config, com.example.administrator.xiaoshuoyuedushenqi.weyue.db.entity.DaoSession daoSession) {
