...
import com.example.administrator.xiaoshuoyuedushenqi.weyue.widget.theme.Theme;
...
public class BaseUtils {
    ...
    public static void setIconDrawable(TextView view, @DrawableRes int iconRes) {
        view.setCompoundDrawablesWithIntrinsicBounds(App.getAppResources().getDrawable(iconRes),
                null, null, null);
