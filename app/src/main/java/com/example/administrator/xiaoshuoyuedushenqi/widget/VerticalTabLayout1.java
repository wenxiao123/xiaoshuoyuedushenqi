 ...
 */
public class VerticalTabLayout1 extends NestedScrollView {
    ...
    private List<VerticalTabLayout1.OnTabSelectedListener> mTabSelectedListeners;
    private VerticalTabLayout1.OnTabPageChangeListener mTabPageChangeListener;
    private DataSetObserver mPagerAdapterObserver;

    private TabFragmentManager1 mTabFragmentManager;

    public VerticalTabLayout1(Context context) {
        this(context, null);
    }

    public VerticalTabLayout1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VerticalTabLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initTabStrip() {
        mTabStrip = new VerticalTabLayout1.TabStrip(mContext);
    ...
    private void setTabSelectedImpl(final int position, boolean updataIndicator, boolean callListener) {
        ...
        if (callListener) {
            for (int i = 0; i < mTabSelectedListeners.size(); i++) {
               VerticalTabLayout1.OnTabSelectedListener listener = mTabSelectedListeners.get(i);
                if (listener != null) {
                    if (selected) {
...
//    }
    ...
    public void addOnTabSelectedListener(VerticalTabLayout1.OnTabSelectedListener listener) {
        if (listener != null) {
            mTabSelectedListeners.add(listener);
        }
    }

    public void removeOnTabSelectedListener(VerticalTabLayout1.OnTabSelectedListener listener) {
        if (listener != null) {
    ...
    public void setTabAdapter(TabAdapter adapter) {
        ...
        if (adapter != null) {
            ...
            for (int i = 0; i < adapter.getCount(); i++) {
                addTab(new QTabView1(mContext).setIcon(adapter.getIcon(i))
    ...
    public void setupWithFragment(FragmentManager manager, int containerResid, List<Fragment> fragments) {
        ...
        if (containerResid != 0) {
            mTabFragmentManager = new TabFragmentManager1(manager, containerResid, fragments, this);
        } else {
            mTabFragmentManager = new TabFragmentManager1(manager, fragments, this);
        }
    }
    ...
    public void setupWithViewPager(@Nullable ViewPager viewPager) {
        ...
        if (viewPager != null) {
            ...
            if (mTabPageChangeListener == null) {
                mTabPageChangeListener = new VerticalTabLayout1.OnTabPageChangeListener();
            }
            viewPager.addOnPageChangeListener(mTabPageChangeListener);

            addOnTabSelectedListener(new VerticalTabLayout1.OnTabSelectedListener() {
                @Override
    ...
    private void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new VerticalTabLayout1.PagerAdapterObserver();
            }
