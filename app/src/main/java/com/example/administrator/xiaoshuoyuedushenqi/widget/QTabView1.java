...
public class QTabView1 extends TabView {
    ...
    public QTabView1(Context context) {
        super(context);
        mContext = context;
    ...
    @Override
    public QTabView1 setBadge(TabBadge badge) {
        if (badge != null) {
            mTabBadge = badge;
        }
        initBadge();
    ...
    @Override
    public QTabView1 setIcon(TabIcon icon) {
        if (icon != null) {
            mTabIcon = icon;
        }
        initIconView();
    ...
    @Override
    public QTabView1 setTitle(TabTitle title) {
        if (title != null) {
            mTabTitle = title;
        }
        initTitleView();
     ...
     */
    @Override
    public QTabView1 setBackground(int resId) {
        if (resId == 0) {
            setDefaultBackground();
        } else if (resId <= 0) {
            setBackground(null);
