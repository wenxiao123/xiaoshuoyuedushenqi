...
import com.novel.collection.adapter.BookstoreCategoryAdapter;
...
import com.novel.collection.presenter.ExclusivePresenter;
import com.novel.collection.util.MyGridSpacingItemDecoration;
...
public class ExclusivelistGFragment extends BaseFragment<ExclusivePresenter> implements IExclusiveContract.View {
    ...
    RelativeLayout rv_renqi_title,rv_new_title,rv_new_renqi_title;
    @Override
    ...
    protected void initView() {
        rv_renqi_title=getActivity().findViewById(R.id.rv_renqi_title);
        rv_new_title=getActivity().findViewById(R.id.rv_new_title);
        rv_new_renqi_title=getActivity().findViewById(R.id.rv_new_renqi_title);
    ...
    public void getCategoryNovelsSuccess(List<Noval_details> dataList) {
        if(dataList.size()==0){
            rv_new_renqi_title.setVisibility(View.GONE);
        }else {
    ...
    public void getCategoryNovels2Success(List<Noval_details> dataList) {
        if(dataList.size()==0){
            rv_new_title.setVisibility(View.GONE);
        }else {
