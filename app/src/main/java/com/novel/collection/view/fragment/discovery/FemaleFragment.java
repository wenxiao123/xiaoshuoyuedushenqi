 ...
 */
public class FemaleFragment extends BaseTabFragment<MalePresenter>
    ...
    RelativeLayout rel_hot,rel_new;
    @Override
    ...
    protected void initView() {
        TextView tv_hot_more=getActivity().findViewById(R.id.tv_female_category_more);
        ...
        rel_hot=getActivity().findViewById(R.id.rel_hot_famale);
        rel_new=getActivity().findViewById(R.id.rv_new_female);
        getActivity().findViewById(R.id.iv_female_category_more).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), RankingActivity.class);
                intent.putExtra("type",3);
        ...
        TextView tv_item_new_more=getActivity().findViewById(R.id.tv_female_new_more);
        ...
        mNewRv=getActivity().findViewById(R.id.rv_female_new_novel_list);
        mNewRv.setLayoutManager(new GridLayoutManager(getContext(), 4));

        rel_click_more = getActivity().findViewById(R.id.click_more_female);
        ...
        banner = getActivity().findViewById(R.id.ultra_viewpager_female);
        uIndicator4 = getActivity().findViewById(R.id.indicator_female);
    }
    @Override
