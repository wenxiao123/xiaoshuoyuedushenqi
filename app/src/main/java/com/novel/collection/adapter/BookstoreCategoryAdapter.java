 ...
 */
public class BookstoreCategoryAdapter extends RecyclerView.Adapter<BookstoreCategoryAdapter.CategoryViewHolder>{
    ...
    public BookstoreCategoryAdapter(Context mContext, List<String> mCategoryNameList,
    ...
    public CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new CategoryViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_book_category, null));
    }
