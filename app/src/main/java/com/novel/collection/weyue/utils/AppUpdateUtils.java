...
import com.novel.collection.weyue.model.AppUpdateBean;
...
//                                Uri contentUri = FileProvider.getUriForFile(mContext, "com.novel.collection.weyue.FileProvider", new File(filePath));
