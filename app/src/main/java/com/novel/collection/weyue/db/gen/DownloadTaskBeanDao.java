package com.novel.collection.weyue.db.gen;
...
public class DownloadTaskBeanDao extends AbstractDao<DownloadTaskBean, String> {
    ...
    public DownloadTaskBeanDao(DaoConfig config, com.novel.collection.weyue.db.gen.DaoSession daoSession) {
        super(config);
    }
    
    public DownloadTaskBeanDao(DaoConfig config, com.novel.collection.weyue.db.entity.DaoSession daoSession) {
