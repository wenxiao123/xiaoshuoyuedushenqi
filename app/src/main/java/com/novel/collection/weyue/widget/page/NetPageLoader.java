...
import com.novel.collection.entity.bean.Other_one;
...
import com.novel.collection.weyue.db.helper.CollBookHelper;
    ...
    private void getOtherCatalogDataSuccess(List<Other_one> catalogData) {
        ...
        if (weigh < other_max || (o == 1 && catalogData.size() < other_max)) {
            ...
            if (o < weigh / other_max) {
                ...
                if (o == weigh / other_max && weigh % other_max != 0) {
                    LogUtils.e(o + "---" + weigh / 50);
                    other_ones.addAll(catalogData);
                    handler.sendEmptyMessage(3);
                } else {
