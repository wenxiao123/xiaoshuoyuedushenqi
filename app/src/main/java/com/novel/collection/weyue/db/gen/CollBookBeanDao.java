...
public class CollBookBeanDao extends AbstractDao<CollBookBean, String> {
    ...
    public CollBookBeanDao(DaoConfig config, com.novel.collection.weyue.db.gen.DaoSession daoSession) {
        super(config);
    }
    
    public CollBookBeanDao(DaoConfig config, com.novel.collection.weyue.db.entity.DaoSession daoSession) {
